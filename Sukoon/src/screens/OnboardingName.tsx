...
export default function OnboardingName({ onNext, onSkip }: { onNext: () => void, onSkip: () => void }) {
  ...
  return (
    <div className="flex-1 flex flex-col bg-surface overflow-hidden">
      ...
      <header className="relative h-[260px] flex items-center justify-center shrink-0">
        <motion.div 
        ...
        >
          <div className="relative w-56 h-56">
            ...
            <img alt="Sanctuary" className="relative z-10 w-full h-full object-contain drop-shadow-2xl" src="https://lh3.googleusercontent.com/aida-public/AB6AXuAeD1nwapxbIAziYs0Tve09wdzbDV-oTc6S-RfJsv-uNLPZNUrV_9HGg0fkPyvC8Yph0a_bjxI5VSCioHxyf2OTdUXcONaUAiyGp0QKIQJGkcgUpStCxN3sA5IMpDGr8UHwtgdTbMLQ0ahYYgaqSMYrEaK2bGCj5ZIJArbuUfDOjub0x-o66u41AkfWowg9k34GduyM94AINNGNYATnR5dJenT1OalaZg3sZRchR8c9C0ySSHfZpswtWwN9Hz69aoaUaISPTz_RtQ_v" />
          </div>
        </motion.div>
      </header>
      ...
      <motion.main 
        ...
        className="flex-1 flex flex-col px-6 pt-8 pb-10 bg-white rounded-t-[2.5rem] relative z-20 shadow-[0_-10px_40px_rgba(0,0,0,0.05)]"
      >
